...
export function OrderTableFilters() {
  ...
  function handleClearFilters() {
    ...
    // reset do campo do form
    reset({ orderId: '', status: '', customerName: '' })
  }
  ...
  return (
    ...
    >
      ...
      />
      {/* usando o Controller e o control é a forma de monitorar as infos em 
      componentes nao nativos do html */}
      <Controller
        name="status"
        control={control}
